    ...
    <main>
      ...
      <section style={s("position:relative;background:#0F0F11;overflow:hidden;")}>
        ...
        <div style={s("position:relative;max-width:1240px;margin:0 auto;padding:" + (isMobile ? "72px 24px 84px" : "120px 32px 130px") + ";width:100%;")}>
          ...
          <h1 style={s("font-family:'Oswald',sans-serif;font-weight:700;text-transform:uppercase;color:#fff;font-size:clamp(44px,7vw,92px);line-height:1.15;letter-spacing:-.005em;margin:0;max-width:16ch;")}>{texts.heroTitle}<span style={{ color: "#E01E26" }}>{texts.heroAccent}</span></h1>
